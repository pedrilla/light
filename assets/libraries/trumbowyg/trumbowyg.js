...
(function (navigator, window, document, $) {
    ...
    var CLOSE_CONTAINER = 'tbw_close_container';
    ...
    Trumbowyg.prototype = {
        ...
        openContainer: function (title, content, settings)
        {
            ...
            var $modal = $('<div/>', {
                class: prefix + 'modal ' + prefix + 'fixed-top ' + prefix + 'container' + ' ' + settings.class
            }).css({
            ...
            t.$overlay.one('click', function () {
                $modal.trigger(CLOSE_CONTAINER);
                return false;
            });

            $modal.one(CLOSE_CONTAINER, function () {
            ...
            if (settings.showClose) {
                $('<i class="fa fa-times" aria-hidden="true"></i>').prependTo($box).on('click', function () {
                    $modal.trigger(CLOSE_CONTAINER);
                });
            }
